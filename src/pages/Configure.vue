...
<template>
  ...
  >
    ...
    <p class="text-sm">
      Les instances personnalisées nécessitent l'ouverture de ports pour
      communiquer à l'extérieur de votre réseau.
    </p>
  </div>
  ...
  <div class="h-screen flex flex-col justify-center items-center">
    <div>
      ...
      <Title
        ...
        :description="`Étape ${step}/2 : configurer le serveur de découverte`"
      />
      ...
      <div v-if="step === 1">
        ...
        <div class="mt-10">
          <h2 class="flex font-semibold text-xl">
            Serveur Turms discovery <span class="text-red-500">*</span>
            <svg
              @mouseover="discoveryTooltip = true"
              @mouseleave="discoveryTooltip = false"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
              class="size-6"
        ...
        <h2 class="mt-10 font-semibold text-xl">
          Vous identifier sur le réseau <span class="text-red-500">*</span>
        </h2>
        <div class="flex">
          <input
      ...
      <div v-if="step === 2">
        ...
        <div class="mt-10">
          ...
          <h3 class="mt-4 font-semibold text-md">
            URL du serveur STUN <span class="text-red-500">*</span>
          </h3>
          <input
            class="w-[23rem] h-7 text-sm text-zinc-700 dark:text-zinc-200 dark:placeholder:text-zinc-300 outline-none bg-transparent border border-zinc-400 dark:border-zinc-700 border-b-2 border-x-0 border-t-0"
            type="text"
          ...
          <h3 class="mt-4 font-semibold text-md">
            Authentification au serveur STUN
          </h3>
      ...
      <div v-else class="flex justify-center space-x-4">
        <SecondaryButton
          v-if="step > 1"
          @click="step--"
          class="mt-16 w-48 flex justify-center items-center text-zinc-100"
        >
          Précédent
        </SecondaryButton>
        <PrimaryButton
