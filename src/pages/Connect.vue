...
<template>
    <div class="h-screen flex flex-col justify-center items-center">
        <Title title="Bienvenue sur Turms" description="Accédez à votre messagerie sécurisée pair-à-pair." />

        <PrimaryButton class="mt-16 w-[23rem] flex justify-center items-center text-zinc-100" @click="openAuthPage">
        ...
        <div class="flex mt-4 items-center text-center w-[23rem]">
                                ...
                                <label class="block font-medium text-sm text-zinc-600 w-full">
                                    OU
                                </label>
                                <hr class="border-zinc-300 border-1 w-full rounded-md">
                            </div>

        <SecondaryButton class="mt-4 w-[23rem] flex justify-center items-center" @click="router.push('/configure')">
